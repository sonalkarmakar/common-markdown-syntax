...
- [Line Breaks](<#Line Breaks>)
	...
	- [New Line](<#New Line>)
- [Emphasis / Styling](<#Emphasis / Styling>)
- [Horizontal Line](<#Horizontal Line>)
- [Lists](#Lists)
	- [Unordered Lists](<#Unordered Lists>)
	- [Ordered Lists](<#Ordered Lists>)
	- [Mixing List Types](<#Mixing List Types>)
...
- [Code Blocks](<#Basic Code Block>)
	- [Basic Code Block](<#Basic Code Block>)
	- [Syntax Highlighting](<#Syntax Highlighting>)
	- [Backtick Fencing](<#Backtick Fencing>)
- [Tables](#Tables)
- [Colour Chips](<#Colour Chips>)
- [Collapsible Sections](<#Collapsible Sections>)
- [LaTeX Mathematic Expressions](<#LaTeX Mathematic Expressions>)
